...
- (void)layoutSubviewsInsideBounds:(CGRect)bounds
{
    ...
    if (_labelingPolicy == QLabelingPolicyTrimTitle)
    {
        ...
        if (self.detailTextLabel.text!=nil) {
            NSAttributedString *attributedText = [[NSAttributedString alloc] initWithString:self.detailTextLabel.text attributes:@{NSFontAttributeName: self.detailTextLabel.font}];
            CGRect rect = [attributedText boundingRectWithSize:sizeWithMargin
