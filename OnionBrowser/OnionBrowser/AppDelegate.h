...
// either nil (to load regular homepage) or url given by a "theonionbrowser://" (HTTP)
// or "theonionbrowsers://" (HTTPS) callback url -- when this app is started from another app
