...
- (id)initWithStyle:(UITableViewStyle)style
{
	...
	if ([[self.appDelegate appWebView] curWebViewTab] != nil) {
		self.inUseRuleNames = [[NSMutableArray alloc] initWithArray:[[[[[self.appDelegate appWebView] curWebViewTab] applicableHTTPSEverywhereRules] allKeys] sortedArrayUsingSelector:@selector(localizedCaseInsensitiveCompare:)]];
	}
	else {
